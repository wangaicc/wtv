...
# ====================================================================
# Ubuntu SSH 安全加固与内存清理一键脚本 (支持 Root 密钥登录)
# ====================================================================
...
# 写入完整的安全配置（包含 Include 引用，端口 18222，仅限密钥登录）
cat << 'EOF' > "$SSH_CONFIG"
# ====================================================================
...
# 2. 认证与访问控制
# --------------------------------------------------------------------
# 允许 root 登录，但严格限制只能通过 SSH 密钥认证，拒绝密码登录
...
echo "👉 请立即打开一个新的终端窗口测试：ssh -p 18222 root@服务器IP"
echo "=================================================="
